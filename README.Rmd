...
R version 4.5.1 and `ntsworkflow` 0.2.9 (or later) and the CSL (spectral library) version 25.5 (or later) are required (see [ntsworkflow on Github](github.com/bafg-bund/ntsworkflow)). For other dependencies see the `DESCRIPTION`.
